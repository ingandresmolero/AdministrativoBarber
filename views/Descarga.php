...
<body>
    ...
    <section class="container">
        <h1 class="page-heading">Descarga de Inventario</h1>
        ...
        <div class="row justify-content-center">
            <form action="" method="post">
                ...
                <div class="col ">
                    ...
                    <a href="Descarga.php" class="table-btn">Mostrar Todos</a>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <?php foreach ($resultado_usuario as $usuario) :   ?>
                            <?php if ($rol == 'admin') { ?>
                                <tr>
                                    <form action="./operacion/actualizarDescarga.php" method="post">
                                        ...
                                        <!-- <td class="action"><a class="table-btn text-dark" href="../views/operacion/actualizarDescarga.php?idproduct=<?php echo $usuario['idproducts'] ?>">+</a></td> -->
                                        <td class="action"> <input type="submit" class="table-btn" value="+" name="Descarga"> </td>
                                    </form>
                                </tr>
                                <?php } else {
                                if ($rol == 'manager') { ?>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                "><a class="page-link" href="Descarga.php?pagina=<?php echo $_GET['pagina'] - 1; ?>">Anterior</a></li>

                <?php for ($i = 0; $i < $paginas; $i++) : ?>
                    <li class="page-item pnum <?php echo $_GET['pagina'] == $i + 1 ? ' active' : '' ?>"><a class="page-link" href="Descarga.php?pagina=<?php echo $i + 1; ?>"><?php echo $i + 1; ?></a></li>
                <?php endfor  ?>


                <li class="page-item
                <?php echo $_GET['pagina'] >= $paginas ? ' disabled' : '' ?> 
                "><a class="page-link" href="Descarga.php?pagina=<?php echo $_GET['pagina'] + 1; ?>">Siguiente</a></li>
            </ul>
        </nav>
