...
$sql = "SELECT * from vales inner join tbladmin on vales.idbarber = tbladmin.ID WHERE tbladmin.AdminName ='$nombreservidor'";
            ...
            <table class="table table-style">
                ...
                <tbody>
                    ...
                    if (!isset($_POST['busqueda'])) {
                        ...
                        $sql_usuarios = "SELECT idvale, monto, metodos_pago.unidad , metodos_pago.nombre, vales.estado,vales.fecha from vales inner join tbladmin on vales.idbarber = tbladmin.ID inner join metodos_pago on vales.metodo_pago = metodos_pago.idmetodo WHERE tbladmin.AdminName ='$nombreservidor' LIMIT :iniciar, :nusuarios;";
