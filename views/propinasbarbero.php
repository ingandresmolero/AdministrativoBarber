    ...
    <section class="container">
            ...
            <table class="table table-style">
                ...
                <tbody>
                    ...
                    if (!isset($_POST['busqueda'])) {
                        ...
                        $sql_report = "SELECT * FROM tblassignedservice inner join tblbarber on tblbarber.idbarber = tblassignedservice.idbarbero WHERE tblbarber.nombre = '$nombreservidor' ORDER BY invoice DESC LIMIT :iniciar,:nusuarios";
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                "><a class="page-link" href="propinasbarbero.php?pagina=<?php echo $_GET['pagina'] - 1; ?>">Anterior</a></li>
                ...
                <li class="page-item
                <?php echo $_GET['pagina'] >= $paginas ? ' disabled' : '' ?> 
                "><a class="page-link" href="propinasbarbero.php?pagina=<?php echo $_GET['pagina'] + 1; ?>">Siguiente</a></li>
            </ul>
        </nav>
    </section>
