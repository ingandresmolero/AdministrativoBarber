...
<body>
    ...
    <main>
        ...
        <section class="container-sm  card  p-3 shadow p-3 mb-3 bg-white rounded mt-5">
            <div class=" row ">
                <div class="col-md-3">
                    <a class="btn btn-danger" href="assets/barberos/clientesatendidos.php">Volver </a>
                </div>
            </div>
            ...
            <div class="">
                ...
                <section>
                    ...
                    <form action="operaciones-producto.php" method="POST">
                        ...
                        <div class=" card shadow p-3 mb-3 mt-5 bg-white rounded">
                            ...
                            <table class="table table-bordered mb-3" width="100%" border="1">
                                ...
                                <?php
                                $ret = mysqli_query($conexion, "SELECT * FROM tblassignedservice INNER JOIN tblservices ON tblassignedservice.servicio = tblservices.ID INNER JOIN tblbarber ON tblassignedservice.idbarbero = tblbarber.idbarber WHERE tblassignedservice.invoice = '$billing' AND tblbarber.nombre='$nombreservidor'");
                                $cntservicio = 1;
                                $gtotal1 = 0;
