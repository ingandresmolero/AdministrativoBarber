...
$sql = 'SELECT * FROM transacciones inner JOIN tblinvoice on transacciones.invoice = tblinvoice.BillingId INNER JOIN tblcustomers on tblinvoice.Userid = tblcustomers.ID';
            ...
            <table class="table table-style">
                ...
                <tbody>
                    ...
                    if (!isset($_POST['busqueda'])) {
                        ...
                        $sql_report = "SELECT * FROM transacciones inner JOIN tblinvoice on transacciones.invoice = tblinvoice.BillingId INNER JOIN tblcustomers on tblinvoice.Userid = tblcustomers.ID WHERE estatus != 'Totalizado' ORDER BY invoice DESC LIMIT :iniciar,:nusuarios";
