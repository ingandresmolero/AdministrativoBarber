...
--
-- Servidor: localhost
-- Tiempo de generación: 03-10-2023 a las 19:06:27
...
(58, 23, 5, '43', 'pago completo', '14/09/2023');
...
CREATE TABLE `facturas` (
  ...
  `barbero` varchar(45) NOT NULL DEFAULT '0',
...
(17, 'rodney', 'rodney', NULL, NULL, '81dc9bdb52d04dc20036dbd8313ed055', '2023-09-14 15:15:38', 'usuario'),
(18, 'Barbero1', 'barbero1', NULL, NULL, '827ccb0eea8a706c4c34a16891f84e7b', '2023-09-14 15:28:57', 'usuario'),
(19, 'Barbero2', 'barbero2', NULL, NULL, '827ccb0eea8a706c4c34a16891f84e7b', '2023-09-14 15:29:20', 'usuario');
...
CREATE TABLE `tblassignedservice` (
  `idservicioasignado` int(11) NOT NULL,
  `invoice` int(11) NOT NULL,
...
CREATE TABLE `tblbarber` (
  ...
  `Telefono` varchar(45) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(21, 'Barbero1', '0', 'barbero1', '827ccb0eea8a706c4c34a16891f84e7b', '0', '0', '0'),
(22, 'Barbero2', '0', 'barbero2', '827ccb0eea8a706c4c34a16891f84e7b', '0', '0', '0');
...
(1, 'Barberia Activo C.A', '123456', 'maracaibo', '12345678', 39);
...
(112, 39, NULL, 3, 38, '2023-09-15 15:42:22', 'pendiente'),
(94, 36, 23, 1, 23, '2023-07-19 18:14:37', 'pagado'),
(103, 38, 20, 3, 29, '2023-07-20 14:59:30', 'pagado'),
(104, 38, NULL, 1, 30, '2023-07-25 18:35:35', 'pagado'),
(105, 32, NULL, 1, 31, '2023-07-26 14:20:42', 'pagado'),
...
CREATE TABLE `tblproducts` (
  ...
  `deposito` varchar(45) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(13, 23, '43', '28', 'Totalizado', '43', '14/09/2023');
...
CREATE TABLE `vales` (
  ...
  `idbarber` varchar(20) NOT NULL,
  `monto` varchar(20) NOT NULL,
  `detalle` varchar(200) NOT NULL,
  `fecha` varchar(45) NOT NULL,
  `metodo_pago` varchar(10) NOT NULL,
  `estatus` varchar(45) NOT NULL,
  `fecha_2` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `vales` (`idvale`, `idbarber`, `monto`, `detalle`, `fecha`, `metodo_pago`, `estatus`, `fecha_2`) VALUES
