...
<body id="dashboard">
    ...
    <section class="container">
        <div class="elements">
            <div class="item">
                <a href="stock.php" class="inventario">
            ...
            <div class="item">
                <a href="operaciones.php" class="operaciones">
        ...
        <div class="elements">
            <div class="item">
                <a href="reportes.php" class="reportes">
            ...
            <div class="item">
                <a href="usuarios.php" class="usuarios">
            ...
            <div class="item">
                <a href="configuracion.php" class="config">
