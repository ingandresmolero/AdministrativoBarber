...
<body>
    ...
    <section class="container">
        ...
        <button type="button" class="btn btn-style-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
            Nuevo Usuario
        </button>
        <div class="row b-3">
            <div class="col-md">
                <form action="" method="post">
                    ...
                    <input type="submit" class="btn-style-1" value="busqueda" name="busqueda">
                    <a href="usuarios.php" class="btn-style-1">Mostrar Todos</a>
                </form>
            </div>
        </div>
