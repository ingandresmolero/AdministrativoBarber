...
-- Tiempo de generación: 18-08-2023 a las 15:36:30
...
(104, 38, NULL, 1, 30, '2023-07-25 18:35:35', 'pendiente'),
...
(110, 39, NULL, 1, 36, '2023-08-18 15:10:24', 'pendiente'),
...
--
ALTER TABLE `cuentas_cobrar`
  MODIFY `idcuenta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `tblassignedproducts`
  MODIFY `id_assigned` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `tblbarber`
  MODIFY `idbarber` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `transacciones`
  MODIFY `idtransac` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
